...
class starter {
		...
		*/
		while(true){
			...
			if(choice.equals("file")){
				...
				System.out.println("The word: "+ choice3 +" apears " +checksArray(arr, choice3)+" times");
			}
			else if(choice.equals("common")){
				mostCommon(arr);
				System.out.println("Most common word is "+ mostCommon(arr));
			}
	...
	*/
	public static void printsNumber(String[] arr, int num){
		...
		else if( num < arr.length-1 && num > -1){
			for(int i = num; i>0; i--){
			System.out.print(arr[i]+" ");
			}
		}
	...
	*/
	public static int checksArray(String[] arr, String check){
		...
		return amount;	// Dummy value, delete when needed.
	}
	...
	*/
	public static String mostCommon(String[] arr){
		...
		return bladablada;	// Dummy value, delete when needed.
	}
